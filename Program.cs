...
string[] names2 = new[] { "Ashleigh", "Jim", "Kyle", "Tom" };
...
{
  { "Marie", "Danny", "Kim", "Rick" },
  { "Maria", "Erica", "Amor", "Rose" },
  { "Lion", "Tiger", "Fish", "Spider" }
};
...
grid2[0, 0] = "Marie"; // assign string values
// and so on
grid2[2, 3] = "Spider";

string[][] jagged = new[] // array of string arrays
{
  new[] { "Maria", "Erica", "Amor" },
  new[] { "Rose", "Kim", "Rose", "Marie" },
  new[] { "Fish", "Spider" }
};
